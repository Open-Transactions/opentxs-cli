...
class OTAPI_Basic {
	...
	static function sendNymInstrument($SERVER_ID,$USER_ID,$USER_ID_RECIPIENT,$RECIPIENT_PUBKEY,$THE_INSTRUMENT,$INSTRUMENT_FOR_SENDER) {
		return OTAPI_Basic_sendNymInstrument($SERVER_ID,$USER_ID,$USER_ID_RECIPIENT,$RECIPIENT_PUBKEY,$THE_INSTRUMENT,$INSTRUMENT_FOR_SENDER);
	}
